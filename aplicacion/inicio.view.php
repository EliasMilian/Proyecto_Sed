...
<body>
<div class="header">
        <h1>Registro de Notas - Centro Universitario "Jorge Magico Gonzales"</h1>
...
<div class="body">
    <div class="panel">
           <h1 class="text-center">Centro Universitario "Jorge Magico Gonzales"</h1>
        <?php
        if(isset($_GET['err'])){
...
<p class="text-center">
    ...
    00083223 – Camilo Raúl Benítez Sigüenza<br>
    00092822 – Elías Alejandro Milian Rivera<br>
    00085720 – Diego Antonio Contreras Rivera
</p>
        </div>
</div>
